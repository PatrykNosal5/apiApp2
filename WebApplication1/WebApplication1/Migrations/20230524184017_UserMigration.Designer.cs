...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20230524184017_UserMigration")]
            ...
            modelBuilder.Entity("WebApplication1.Models.Patient", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPatient = 1,
                            Birthdate = new DateTime(2023, 5, 24, 20, 40, 16, 793, DateTimeKind.Local).AddTicks(9355),
                            FirstName = "Jan",
                            LastName = "Koka"
                        },
                        new
                        {
                            IdPatient = 2,
                            Birthdate = new DateTime(2023, 5, 24, 20, 40, 16, 793, DateTimeKind.Local).AddTicks(9366),
                            FirstName = "Marian",
                            LastName = "Kowa"
                        });
                });
            ...
            modelBuilder.Entity("WebApplication1.Models.Prescription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdPrescription = 1,
                            Date = new DateTime(2023, 5, 24, 20, 40, 16, 793, DateTimeKind.Local).AddTicks(9214),
                            DueDate = new DateTime(2023, 5, 24, 20, 40, 16, 793, DateTimeKind.Local).AddTicks(9270),
                            IdDoctor = 1,
                            IdPatient = 1
                        },
                        new
                        {
                            IdPrescription = 2,
                            Date = new DateTime(2023, 5, 24, 20, 40, 16, 793, DateTimeKind.Local).AddTicks(9280),
                            DueDate = new DateTime(2023, 5, 24, 20, 40, 16, 793, DateTimeKind.Local).AddTicks(9286),
                            IdDoctor = 2,
                            IdPatient = 2
                        });
                });
